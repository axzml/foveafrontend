...
const VideoDemo = () => {
  return (
    <section className="py-24 bg-[#050505] flex flex-col items-center">
      ...
      >
        {/* 视频外壳 - 模拟精密硬件感 */}
        <div className="relative rounded-2xl overflow-hidden border border-[#333] shadow-[0_0_50px_rgba(0,0,0,0.5)] bg-[#1A1A1A]">
          ...
          {/* 视频主体 */}
          <video
            className="w-full h-auto pt-8 opacity-80 hover:opacity-100 transition-opacity duration-700"
            autoPlay
            muted
            loop
            playsInline
